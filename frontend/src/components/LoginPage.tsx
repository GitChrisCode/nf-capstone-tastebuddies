            ...
            <div className="h-full">
                <div
                    ...
                    <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
                        <form className="flex flex-col items-center justify-center" onSubmit={loginOnSubmit}>
                            ...
                            <div className="text-center lg:text-left mt-4">
                                <button
                                    type="submit"
                                    className="px-4 py-1 text-sm text-Blue-600 font-semibold rounded-full border border-blue-200 hover:text-white hover:bg-blue-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-bule-600 focus:ring-offset-2"
