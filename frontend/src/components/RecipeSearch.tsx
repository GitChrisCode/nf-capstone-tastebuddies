                        ...
                        <div className="ml-2">
                            ...
                            <div className="mt-5 mb-5">
                                <form onSubmit={searchSubmit} className="w-96 ">
                                    ...
                                    <button
                                        type="submit"
                                        className="mt-4 px-4 py-1 w-fit text-sm text-Blue-600 font-semibold rounded-full border border-blue-200 hover:text-white hover:bg-blue-800 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-bule-800 focus:ring-offset-2"
